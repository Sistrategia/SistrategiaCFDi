...
{
    public class ConceptoImpuestosTraslado
    {
        public ConceptoImpuestosTraslado() {
        ...
        [Key]
        public int ConceptoImpuestosTrasladoId { get; set; }

        //[Required]
        //public Guid PublicKey { get; set; }

        /// <summary>
        /// Atributo requerido para señalar la base para el cálculo del impuesto, la determinación de la 
        ...
        /// <summary>
        /// Atributo condicional para señalar el valor de la tasa o cuota del impuesto que se traslada para 
        /// el presente concepto. Es requerido cuando el atributo TipoFactor tenga una clave que corresponda 
        /// a Tasa o Cuota.
        /// </summary>
        ...
        /// <summary>
        /// Atributo condicional para señalar el importe del impuesto trasladado que aplica al concepto. 
        /// No se permiten valores negativos. Es requerido cuando TipoFactor sea Tasa o Cuota
        /// </summary>
